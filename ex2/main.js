...
firstLi.addEventListener('click', blockClickUpper);
secondLi.addEventListener('click', blockClickUpper);
thirdLi.addEventListener('click', blockClickUpper);
...
myWebpage.addEventListener('dblclick', () => {
    window.open('https://github.com/hiagoisoppo', '_blank');
});
